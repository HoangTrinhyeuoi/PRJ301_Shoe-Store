    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <form action="${pageContext.request.contextPath}/login" method="POST">
                ...
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8080/Group_Assignment/loginG&response_type=code&client_id=645828963442-9upejmnjb1ai3s92prkvjq5brh8n1al9.apps.googleusercontent.com&access_type=offline&prompt=consent" class="btn-google">
