<%-- 
    Document   : footer
    Created on : Mar 10, 2025, 8:32:52 AM
    Author     : Admin
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <img src="/Shoes_Store/img/logo/logo.png" alt="" width="100px" height="auto"
                         style="border-radius: 50%;border: 3px solid #000;margin-bottom: 20px;">
                    <ul class="footer__list">
                        <li class="footer__item">
                            <p><i class="fas fa-search-location footer__item-icon"></i> Da Nang, Viet Nam</p>
                        </li>
                        <li class="footer__item">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    ...
                    <ul class="footer__list collapse show" id="demo2">
                        <li class="footer__item">
                            <a href="" class="footer__item--link">FUDN</a>
                        </li>
                    </ul>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-3">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    ...
                    <ul class="footer__list collapse show" id="demo">
                        <li class="footer__item">
                            <a href="/Shoes_Store/view/index.jsp" class="footer__item--link">Trang chủ</a>
                        <li class="footer__item">
                            <a href="/Shoes_Store/view/intro.jsp" class="footer__item--link">Giới thiệu</a>
                        </li>
                        <li class="footer__item">
                            <a href="/Shoes_Store/view/product.jsp" class="footer__item--link">Sản phẩm</a>
                        </li>
                        <li class="footer__item">
                            <a href="/Shoes_Store/view/news.jsp" class="footer__item--link">Tin tức</a>
                        </li>
                        <li class="footer__item">
                            <a href="/Shoes_Store/view/contact.jsp" class="footer__item--link">Liên hệ</a>
                        </li>
                    </ul>
                </div>
            </div>
