            ...
            <div class="col-lg-4">
                <div class="order-summary">
                    ...
                    <div class="mb-3">
                        ...
                        <p>
                            <i class="fas fa-${order.paymentMethod eq 'COD' ? 'money-bill-wave' : 'university'} me-2"></i>
                            ${order.paymentMethod eq 'COD' ? 'Thanh toán khi nhận hàng (COD)' : 'Chuyển khoản ngân hàng'}
                        </p>
                    </div>
